                ...
                <form onSubmit={handleSignIn} className="space-y-4">
                      ...
                      <div className="relative my-6">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                          <span className="bg-background px-2 text-muted-foreground">Em manutenção</span>
                        </div>
                      </div>
                  ...
                  <TabsContent value="phone">
                    <div className="space-y-4">
                      {!showPhoneOTP ? (
                        <>
                          <div className="space-y-2">
                            <Label htmlFor="signup-phone-number">Número de Telefone</Label>
                            <Input 
                          ...
                          <Button 
                            ...
                            disabled={isLoading}
                          >
                            {isLoading ? "Enviando código..." : "Criar conta com telefone"}
                          </Button>
                        </>
                      ) : (
                        <>
